...
* 式によるswitch
    ...
    * 条件も使える。<code>case n>0 && n%2==0</code>みたいな
        * <b>この場合はswtichの条件は無しにするのが当然</b>。各caseでboolを返すのでswtich（のあとに続く条件節）で管理しなくてもいい。無しだと自動的にtrueと見なされる    * caseで与える条件はコンマ区切りで複数与えることができる
...
* ifやswitchでの簡易文は積極的に使うことが望まれるらしい。変数の局所製を高めるというらしいがよくわからん
